                            ...
                            <tbody>
                                ...
                                <c:forEach items = "${requestScope.data}" var="c">
                                    <tr class="font-chu-nho">
                                        ...
                                        <td>${c.status}</td>
                                        <td>
                                            <a ${c.status=='Chưa thanh toán' || c.status=='Thanh toán không thành công' ?'':'hidden'} class="btn btn-danger" href="user?action=confirm-payment&paymentId=${c.paymentId}" role="button">Pay</a>
                                        </td>
                                        <td>
                                            <a ${c.status!='Chưa thanh toán'?'hidden':''} class="btn btn-danger" href="#" onclick="doDelete('${c.roomId}', '${c.total}')" role="button">Delete</a>
                                        </td>
